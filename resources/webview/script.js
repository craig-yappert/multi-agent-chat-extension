// Multi Agent Chat Extension v1.13.0
// This file is now a standalone JavaScript file - no more template literal hell!
...
// MCP server load disabled - no longer needed
...
// MCP server save disabled - no longer needed
...
// MCP server delete disabled - no longer needed
...
// MCP server edit disabled - no longer needed
...
// MCP server display disabled - no longer needed
...
window.showAgentSelector = function() {
	...
	if (modal) {
		...
		console.warn('modelModal element not found');
	}
}
...
window.addEventListener('message', event => {
	...
	switch (message.type) {
		...
		case 'permissionRequest':
			...
			break;
		// MCP server cases removed - no longer supported
		case 'mcpServers':
		case 'mcpServerSaved':
